...
def scrape_and_parse(config_file: str):
...
def compare_two_websites():
    eldorado_items = scrape_and_parse("eldorado")
    foxtrot_items = scrape_and_parse("foxtrot")
